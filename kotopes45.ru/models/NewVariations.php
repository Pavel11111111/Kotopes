...
class NewVariations extends Model
{
    public $nameA;
    /**
     * @var UploadedFile
    ...
    public function rules(){
        return[
            ...
            ['nameA', 'string', 'max'=>20, 'tooLong' => 'Кличка не должна превышать 20 символов, если она больше, то пожалуйста, воспользуйтесь сокращённой версией'],
